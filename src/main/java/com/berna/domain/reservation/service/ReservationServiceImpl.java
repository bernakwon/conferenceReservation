...
public class ReservationServiceImpl implements ReservationService {
	 ...
	 * 
	 */
	private ReservationDetail upsertReservationDetail(ReservationRegistParam reservationRegistParam,
	 ...
	 * 
	 */
	private Boolean isthirtyMinuteCheck(String startTime, String endTime) {
